...
export const addSalaryDetails = async (salary: Salary) => {
    ...
    const salaryDetails = await prisma.paymentDetails.create({
        data: {
            ...
            workDetails: {
                create: {
                    scheduledWorkingDays: salary.workDetails.scheduledWorkingDays == null ? 0 : salary.workDetails.scheduledWorkingDays,
                    numberOfWorkingDays: salary.workDetails.numberOfWorkingDays == null ? 0 : salary.workDetails.numberOfWorkingDays,
                    numberOfPaidHolidays: salary.workDetails.numberOfPaidHolidays  == null ? 0 : salary.workDetails.numberOfPaidHolidays,
                    remainingPaidVacationDays: salary.workDetails.remainingPaidVacationDays == null ? 0 : salary.workDetails.remainingPaidVacationDays,
                    overtime: salary.workDetails.overtime == null ? 0 : salary.workDetails.overtime,
                    timeLate: salary.workDetails.timeLate == null ? 0 : salary.workDetails.timeLate,
                    timeLeavingEarly: salary.workDetails.timeLeavingEarly == null ? 0 : salary.workDetails.timeLeavingEarly,
                    numberOfNonPaidLeave: salary.workDetails.numberOfNonPaidLeave == null ? 0 : salary.workDetails.numberOfNonPaidLeave,
                    numberOfHolidayAllowanceDays: salary.workDetails.numberOfHolidayAllowanceDays == null ? 0 : salary.workDetails.numberOfHolidayAllowanceDays,
